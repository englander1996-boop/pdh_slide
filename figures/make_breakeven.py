...
分岐56.0円/kg・現行95円/kgで-290億円/年。線を濃く・文字大・分岐点を強調。"""
import os
import numpy as np
import matplotlib
matplotlib.use("Agg")
...
ax.annotate("損益分岐点\n$56.0$ 円/kg",xy=(BE,0),xytext=(78,90),

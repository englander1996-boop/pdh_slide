...
# 端点の値注記
ax.annotate("98.6%",xy=(0.5,0.986),fontsize=16,color="#1f7a43",fontweight="bold",ha="center",va="bottom")
ax.annotate("60.7%",xy=(0.02,0.607),fontsize=16,color="#b3601a",fontweight="bold",ha="left",va="bottom")
ax.annotate("38.2%",xy=(0.98,0.382),fontsize=16,color="#b3601a",fontweight="bold",ha="right",va="top")
fig.tight_layout()

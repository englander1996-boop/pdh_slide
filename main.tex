...
\section{熱統合}
\input{slides/04-heat-integration}

\section{反応工程}
\input{slides/05-reaction}

\section{反応器設計}
\input{slides/06-reactor-design}

\section{反応器設計に用いた方程式}
\input{slides/07-reactor-model}
...
\section{分離戦略}
\input{slides/10-separation-strategy}

\section{蒸留分離}
\input{slides/11-distillation-columns}

\section{膜分離}
\input{slides/12-propylene-purification}
...
\section{最適化変数の選定}
\input{slides/15-optimization-variables}

\section{経済分析}
\input{slides/16-economics}

...
\begin{frame}
  ...
  \begin{columns}[T,onlytextwidth]
      ...
      {\setlength{\fboxsep}{5pt}\setlength{\fboxrule}{1pt}%
       \fcolorbox{HeaderBlue}{white}{%
        ...
        \begin{tabular}{@{}l@{\hspace{1em}}l@{}}
          ...
          プロピレン純度   & {\large\boldmath$99.5$} wt\%  \\
          水素純度         & $99.9$ mol\% \\
          年間稼働         & $8000$ h/年 \\
    ...
    \begin{column}{0.50\textwidth}
      ...
      \vspace{0.2em}
      % 枠1：反応器（設計の主役なので独立枠で強調）
      {\setlength{\fboxsep}{5pt}\setlength{\fboxrule}{1pt}%
       \fcolorbox{HeaderBlue}{white}{%
        \footnotesize\renewcommand{\arraystretch}{1.17}%
        \begin{tabular}{@{}p{5.5cm}@{}}
          \raggedright\textbf{反応器}\quad \mbox{入口温度 $935.2$ K}・\mbox{サイクル $14.00$ min}・\mbox{内径 $10.76$ m}・\mbox{浅床厚 $1.577$ m}・\mbox{並列基数 $7$}・\mbox{粒径 $5.843$ mm}
        \end{tabular}}}\par
      \vspace{0.22em}
      % 枠2：その他ユニット（分離・供給）
      {\setlength{\fboxsep}{5pt}\setlength{\fboxrule}{1pt}%

  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        \node[part] (hgm)   at (3.7,2.85) {床内発熱材で補温};
      ...
      {\scriptsize\renewcommand{\arraystretch}{1.15}%
       \begin{tabular}{@{}l l c@{}}
         ...
         \multirow{2}{*}{熱補償}
            & 段間再加熱 & $\times$ \\
            & {\color{SpRed}床内発熱材}   & $\bigcirc$ \\
         \bottomrule
       \end{tabular}}\par
      \vspace{0.25em}
      {\tiny\raggedright $\times$ 移動床は失活追従不可、$\triangle$ 径方向流は機構複雑\par
       \vspace{0.18em}
       $\times$ 段間再加熱は床温を戻すのみで分単位の急速失活に間に合わない。切替再生で蓄えた熱を発熱材が床内補償\par}
    \end{column}
    ...
    \begin{column}{0.60\textwidth}
      ...
      \hspace*{9mm}\begin{minipage}{\dimexpr\linewidth-9mm\relax}
        ...
        {\scriptsize\raggedright\linespread{1.18}\selectfont
          ...
          ・床内の\textbf{発熱材}が反応熱を供給し床温を維持。\par
      ...
      \begin{tikzpicture}[
        ...
        \node[lbl, anchor=east, font=\scriptsize] (bl) at (-2.15,1.30) {触媒・発熱材\\浅床};

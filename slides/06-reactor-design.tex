      ...
      \begin{tikzpicture}[
        ...
        \foreach \dx/\toplab/\botlab/\stt/\bcol/\acol in {%
          ...
          \begin{scope}[xshift=\dx cm]
            ...
            % 状態ラベル
            \node[font=\Large\bfseries, text=\acol] at (0,-\ry-1.78) {\stt};
          \end{scope}
        }
        % 浅床ラベル（左器）
        ...
        \draw[{Stealth[length=2.6mm]}-{Stealth[length=2.6mm]}, line width=1.6pt, ArrowBlue]
              (1.6,1.1) -- (3.4,1.1);
        \node[lbl, ArrowBlue, font=\normalsize\bfseries, align=center] at (2.5,1.7) {周期\\切替};
        % 中央下：周期交代の総括（枠なし・二器のちょうど真ん中 x=2.5）
        \node[font=\large, align=center, text=black] at (2.5,-3.15)

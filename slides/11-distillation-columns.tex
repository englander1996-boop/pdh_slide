...
\begin{frame}[t]
  ...
  \vspace{0.4mm}   % 帯と本文の重なりを解消（負の余白で帯に食い込ませない）
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.64\textwidth}
      {\scriptsize
       ...
       \begin{tabular}{@{}l c c c@{}}
         ...
         実段数（$\eta=0.8$） & $45$ & $77$ & {\color{SpRed}\boldmath$147$} \\
         塔径 [m] & $4.0$ & $5.9$ & {\color{SpRed}$6.0$} \\
         還流比 & $2.0$ & $11.8$ & {\color{SpRed}$8.3$} \\
         フィード段 & $28$ & $31$ & {\color{SpRed}$96$} \\
         凝縮器 & 全凝縮 & 部分凝縮 & {\color{SpRed}全凝縮} \\
         リボイラ [MW] & $15.8$ & $45.2$ & {\color{SpRed}\boldmath$39.6$} \\
         \bottomrule
       \end{tabular}}
    \end{column}
    ...
    \begin{column}{0.36\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        % 幅は塔径 D[m] に比例（4.0/5.9/6.0）、高さは塔高に比例（33/52/94m）
        % 脱ブタン D4.0 H33m
        ...
        % C3 D6.0 H94m（最難・赤）
        \def\hC{3.81}\def\cC{3.25}\def\wC{0.50}
  ...
  % ===== 下：3塔の段プロファイル（組成・温度）全幅・大きく =====
  \centering
  \includegraphics[width=\linewidth]{dist_profiles}

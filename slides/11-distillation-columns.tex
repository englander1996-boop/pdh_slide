...
\begin{frame}[t]
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.64\textwidth}
      {\scriptsize
       \setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.32}%
       \begin{tabular}{@{}l c c c@{}}
         ...
         塔頂留分 & $\mathrm{C_3H_8}$ & $\mathrm{H_2}\!\cdot\!\mathrm{CH_4}\!\cdot\!\mathrm{C_2}$ & {\color{SpRed}$\mathrm{C_3H_6}$} \\
         ...
         塔頂温度 [$^\circ$C] & $+56$ & $-82$ & {\color{SpRed}$+41$} \\
    ...
    \begin{column}{0.36\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        % 脱ブタン D4.0 H33m
        \def\hB{1.65}\def\cB{0.55}\def\wB{0.33}
        ...
        % 脱エタン D5.9 H52m
        \def\hE{2.60}\def\cE{1.9}\def\wE{0.49}
        ...
        % C3 D7.4 H94m（最難・赤）
        \def\hC{4.70}\def\cC{3.25}\def\wC{0.61}
        ...
        \node[font=\scriptsize, text=black!55, anchor=north] at (1.9,-0.18) {径 $\times$ 高 を実寸比};
      \end{tikzpicture}
    \end{column}
  \end{columns}

  % ===== 下半分は意図的に空ける（後で別要素を配置）=============

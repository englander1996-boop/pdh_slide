...
%   ZIF-8 MMM(PIMOF法in-situ): 無添加57.7/22.5・最高222.5/10.1・頑健量産版74.9/26.6GPU。採用α90/40=楽観側。
      ...
      {\setlength{\fboxsep}{6pt}\setlength{\fboxrule}{1.2pt}%
       \fcolorbox{SepGreen!55!black}{SepGreen!6}{%
        \begin{minipage}[t][4.0cm]{0.93\linewidth}
         {\scriptsize\bfseries\color{SepGreen!40!black} 膜の選定　ZIF-8 混合マトリックス膜 MMM}
         \vfill
         {\scriptsize\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.1}%
          \begin{tabular}{@{}l c c l@{}}
            ...
            ポリマー & 低 & --- & 可塑化・低性能 \\
            {\bfseries\color{SepGreen!40!black} 採用 MMM} & {\bfseries 90} & {\bfseries 40} & 量産可・高選択 \\
            \bottomrule
          \end{tabular}}
         \vfill
         {\scriptsize\raggedright 高選択の鍵＝\textbf{小さい非晶質 ZIF-8}・PIMOF 法で量産\par}
         \vfill
         {\scriptsize\raggedright {\color{SpRed}\textbf{!}}\ 実験室レベル　大面積・連続化で低下＝採用値は楽観側\par}
         \vfill
         {\scriptsize\raggedright 実機の劣化要因：可塑化・競争吸着・濃度分極 等\par}
         \vfill
         {\tiny\color{black!50} 出典　Hua et al. 2024}
        \end{minipage}}}
    \end{column}
  \end{columns}

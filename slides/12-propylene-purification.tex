    ...
    \begin{column}{0.37\textwidth}
      ...
      {\scriptsize\setlength{\tabcolsep}{5pt}\renewcommand{\arraystretch}{0.95}%
       \begin{tabular}{@{}l r@{}}
         ...
         \midrule
         選択性 $\alpha$ & $90$ \\
         $\mathrm{C_3H_6}$透過度 $Q_A$ & $40$ GPU \\
         透過圧 $P_L$ & $1$ atm \\
         \multicolumn{2}{@{}l@{}}{\tiny\color{black!50} 出典 Hua et al., ACS AMI, 16, 15273, 2024}\\
         \midrule
         モジュール数 & $256$ 本 \\
         ステージカット & $37$ \% \\
        ...
        \begin{minipage}[t][4.0cm]{0.93\linewidth}
         ...
         {\scriptsize\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.1}%
          \begin{tabular}{@{}l c c l@{}}
            \toprule
            膜種 & $\alpha$ & $\mathrm{C_3H_6}$\,GPU & 特徴 \\
            \midrule
            多結晶 ZIF-8 & $\sim\!300$ & $52$ & 量産困難・高コスト \\
            高分子膜 & 低 & --- & 可塑化しやすい \\
            {\bfseries\color{SepGreen!40!black} 採用 混合膜} & {\bfseries 90} & {\bfseries 40} & 量産しやすい・高選択 \\
            \bottomrule
          \end{tabular}}
         \vfill
         {\scriptsize\raggedright 高選択の鍵：\textbf{小さい非晶質 ZIF-8}\par}
         \vfill
         {\scriptsize\raggedright {\color{SpRed}\textbf{!}}\ \textbf{スケールアップ}　採用値は実験室レベル。大面積・連続化に成功したと仮定して設計\par}
         \vfill
         {\scriptsize\raggedright {\color{SpRed}\textbf{!}}\ \textbf{経時劣化}　実機では可塑化・競争吸着・濃度分極により性能が低下\par}
        \end{minipage}}}
    \end{column}
  \end{columns}

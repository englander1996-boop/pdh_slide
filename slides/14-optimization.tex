  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      ...
      {\footnotesize\linespread{0.92}\selectfont\raggedright
       {\color{SpGreen}・プロピレン純度 $\ge 99.5$ wt\%}\par
    ...
    % ===== 右：設計変数23の探索範囲（ユニットごとに枠を分割）======
    %  内容・列構成は元のまま。ユニット境界で fcolorbox を分けるだけ。
    %  枠幅は makebox で統一（中身は左詰め）。縦が増えるぶん余白・行間を詰める。
    \begin{column}{0.48\textwidth}
      ...
      \fcolorbox{HeaderBlue}{white}{\makebox[\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax][l]{%
        \scriptsize\renewcommand{\arraystretch}{0.90}%
